...
class City:
    ...
    def to_screen(self, x, y):
        screen_x = ((ORIGIN[0] * TILE_SIZE[0]) + (x - y) * TILE_SIZE[0] // 2) + TILE_SIZE[0] // 2
        screen_y = ((ORIGIN[1] * TILE_SIZE[1]) + (x + y) * TILE_SIZE[1] // 2) + TILE_SIZE[1] // 2
